      ...
      <nav class="navbar navbar-expand-lg navbar-light" style="background-color: var(--bg-cream); padding: 12px 0; border-bottom: 1px solid rgba(0, 0, 0, 0.31);">
        <div class="container-fluid align-items-center">
          ...
          <div class="d-flex align-items-center gap-3 order-lg-last ms-auto">
            ...
            <!-- Dropdown Quản lý/Đăng nhập (Desktop) -->
            <div class="dropdown dropdown-user d-none d-sm-block">
                <a href="#" class="text-decoration-none" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false" title="Tài khoản">
                    <i class="bi bi-person-circle" style="font-size: 1.45rem; color: var(--primary-color);"></i>
                </a>
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm" aria-labelledby="userDropdown" style="background-color: var(--bg-cream);">
                    <li><a class="dropdown-item" href="${basePath}admin.html"><i class="bi bi-shield-lock me-2"></i>Trang Admin</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="${basePath}login.html"><i class="bi bi-box-arrow-in-right me-2"></i>Đăng nhập</a></li>
                </ul>
            </div>
          ...
          <div class="collapse navbar-collapse justify-content-center" id="mobileMenu">
            <ul class="navbar-nav mb-2 mb-lg-0 gap-2 gap-lg-4 text-center mt-3 mt-lg-0" 
              ...
              <!-- Mục tài khoản cho Mobile -->
              <li class="nav-item d-lg-none">
                <hr class="mx-5 opacity-10">
              </li>
              <li class="nav-item d-lg-none">
                <a class="nav-link" href="${basePath}admin.html">
      ...
      searchBtn.addEventListener("click", (e) => {
        if (!searchOpen) {
          ...
          if (searchInput.value.trim() !== "" && urlSearch !== searchInput.value.trim()) {
            ...
            searchOpen = false;
            if (urlSearch) window.location.href = `${basePath}index.html`;
          }
        }
      });
