...
function initGallery() {
    ...
    lightboxThumbnails.forEach((thumb, index) => {
        thumb.addEventListener("click", () => changeImage(index, lightboxMainImages, lightboxThumbnails));
    });
...
case (avgRating === 5.0):
    ...
    if (starsEl) 
        starsEl.innerHTML = generateStars(avgRating);
